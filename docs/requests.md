...
| 2026-09-23 | Claude → Antigravity | **Ownership change:** Claude now owns `apps/web` and is wiring it to real data (Privy, contracts, Supabase). Don't edit `apps/web` unless a task is assigned to you here. | info |
