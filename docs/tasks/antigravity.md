...
21. **Privy**: `PrivyProvider` with X login, embedded wallets on login, Monad testnet as default chain, gas sponsorship on; batched approve+bid; auto-bid UI that creates a session signer.
